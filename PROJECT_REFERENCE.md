...
- `resources/`: Front-end assets and templates.
  ...
  - `resources/views/components/`: Reusable Blade UI components (e.g., buttons, alerts).
...
- **How to use them**: Use `x-` tags in your template files. Ex: `<x-alert type="success" message="Saved!" />`.
...
---
*Note to AI Context: Retain strict adherence to Roots Sage semantics. Use Blade directives correctly, utilize ACF Composer Builder for fields instead of manual arrays where possible, and honor Tailwind v4 syntax.*
