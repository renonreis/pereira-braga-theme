...
@php
    ...
    if ($initials === null && filled($author)) {
...
<div
    ...
    @if ($variant === 'google')
        <div class="flex justify-between items-start gap-6 pb-6 w-full">
            <div class="flex flex-col gap-2">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        <x-paragraph class="leading-tight! text-[#B0BCD0] m-0!">
                            {{ $author }}
                        </x-paragraph>
                        <x-paragraph class="leading-tight! text-[#92A8CC]">
                            {{ $date }}
                        </x-paragraph>
                    </div>
                </div>
